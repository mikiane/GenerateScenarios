...
print("open file /Users/michel/tmp/inputcleanscenarios.csv")
input_datapath = '/Users/michel/tmp/inputcleanscenarios.csv' 
...
df['n_tokens'] = df.Scenarios.apply(lambda x: len(tokenizer.encode(x)))
...
df['ada_embedding'] = df.Scenarios.apply(lambda x: get_embedding(x, engine='text-embedding-ada-002'))
print("embeddings created")
# ecrire la valeur du vecteur contenue dans le dataframe dans un second CSV
df.to_csv('/Users/michel/tmp/outputscenariosembeddings.csv', index=False)
